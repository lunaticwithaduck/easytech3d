...
const MATERIALS_TABLE = [
  ['PLA', '0.55 лв/г', 'Лесен за печат, гладка повърхност', 'Фигурки, прототипи, декорация'],
  ['PLA Pro', '0.55 лв/г', 'По-здрав от стандартен PLA', 'Функционални части, механизми'],
  ['PETG', '0.55 лв/г', 'Издръжлив, химически устойчив', 'Кутии, държачи, инструменти'],
  ['ABS', '0.75 лв/г', 'Топлоустойчив, лек, здрав', 'Авто части, електроника'],
  ['ASA', '0.80 лв/г', 'UV-устойчив, издържа навън', 'Градински аксесоари, табели'],
];

const FAQ = [
  [
    'Колко струва 3D принт по поръчка?',
    'Цената зависи от материала и размера. PLA и PETG от 0.55 лв/г, ABS от 0.75 лв/г, ASA от 0.80 лв/г. Минимална поръчка: 10 лв. За 5+ бройки — 10% отстъпка, за 10+ — 20%.',
  ],
  [
  ...
  [
    ...
    'Да! Доставка с куриер навсякъде в България. Безплатна доставка за поръчки над 150 лв.',
  ],
  [
